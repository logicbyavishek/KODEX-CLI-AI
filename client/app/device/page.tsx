      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center gap-4 mb-8">
          <div className="p-3 rounded-lg border-2 border-dashed border-zinc-700">
            < LuShieldAlert className="w-8 h-8 text-red-600" />
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                maxLength={9}
                className="w-full px-4 py-3 bg-zinc-900 border-2 border-dashed border-zinc-700 rounded-lg text-white focus:outline-none focus:border-zinc-600 font-mono text-center text-lg tracking-widest"
              />
